        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white/10 rounded-lg p-6 inline-block">
              ...
              <p className="text-blue-200">Comprehensive visa renewal assistance</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-blue-900 mb-2">Renewal Guidance</h3>
                ...
                <div className="flex items-start">
                  <span className="text-2xl mr-4">📅</span>
                  <div>
                    <h3 className="text-xl font-semibold text-blue-900 mb-2">Timing Optimization</h3>
                    <p className="text-gray-700">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-blue-900 mb-4">Our Visa Renewal Process</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-blue-900 mb-3">Eligibility Review</h3>
              <p className="text-gray-700">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-blue-900 mb-3">Follow-up & Updates</h3>
              <p className="text-gray-700">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-blue-900 mb-3">When should I apply for visa renewal?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-blue-900 mb-3">How long does visa renewal take?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-blue-900 mb-3">Can I travel while my renewal is being processed?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-blue-900 mb-3">What if my renewal application is refused?</h3>
                <p className="text-gray-700">
