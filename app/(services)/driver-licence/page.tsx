  ...
  return (
    <>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            <nav className="text-blue-600 mb-4">
              ...
              <span className="text-blue-900 font-semibold"> Driver Licence</span>
            </nav>
            ...
            <div className="bg-blue-900 text-white rounded-lg p-6 inline-block">
              ...
              <p className="text-blue-200">Complete driving licence assistance</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-blue-900 mb-2">Provisional Licence Applications</h3>
                ...
                <div className="flex items-start">
                  <span className="text-2xl mr-4">🔄</span>
                  <div>
                    <h3 className="text-xl font-semibold text-blue-900 mb-2">Licence Renewals</h3>
                    <p className="text-gray-700">
                ...
                <div className="flex items-start">
                  <span className="text-2xl mr-4">🔍</span>
                  <div>
                    <h3 className="text-xl font-semibold text-blue-900 mb-2">Lost Licence Replacement</h3>
                    <p className="text-gray-700">
                ...
                <div className="flex items-start">
                  <span className="text-2xl mr-4">🏠</span>
                  <div>
                    <h3 className="text-xl font-semibold text-blue-900 mb-2">Address Changes</h3>
                    <p className="text-gray-700">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-blue-900 mb-4">Our Driver Licence Services</h2>
      ...
      <section className="py-16">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-blue-900 mb-4">Our Driver Licence Process</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-blue-900 mb-3">Initial Assessment</h3>
              <p className="text-gray-700">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-blue-900 mb-3">Document Collection</h3>
              <p className="text-gray-700">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-blue-900 mb-3">Application Processing</h3>
              <p className="text-gray-700">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-blue-900 mb-3">Delivery Support</h3>
              <p className="text-gray-700">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-blue-900 mb-3">How long does a driving licence application take?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-blue-900 mb-3">What are the current DVLA fees?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-blue-900 mb-3">Can you help with medical licence renewals?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-blue-900 mb-3">Do you handle licence applications for all ages?</h3>
                <p className="text-gray-700">
